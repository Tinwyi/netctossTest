...
<head>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function feeTypeChange(type) {
            ...
            if (type == 1) {
                $(":text:eq(1)").attr("readonly","readonly");
                $(":text:eq(1)").attr("ignore","ignore");
                ...
                $(":text:eq(1)").attr("readonly",false);
                $(":text:eq(1)").removeAttr("ignore");
                $(":text:eq(2)").attr("readonly",false);
                $(":text:eq(2)").removeAttr("ignore");
...
<div id="main">
    <form action="addCost" method="post" class="main_form">
        ...
        <div class="input_info">
            <input type="text" class="width300" datatype="s1-50" name="costName"  ajaxurl="checkCostName" errormsg="资费名称长度1-50"/>
        </div>
        ...
        <div class="input_info">
            <input type="text" name="baseDuration" value="" datatype="n1-4" class="width100"/>
            <span class="info">小时</span>
        </div>
        <div class="text_info clearfix"><span>基本费用：</span></div>
        <div class="input_info">
            <input type="text" name="baseCost" value="" errormsg="请输入数字"
        ...
        <div class="input_info">
            <input type="text" name="unitCost" errormsg="请输入数字"
                   datatype="/^-?[1-9]+(\.\d+)?$|^-?0(\.\d+)?$|^-?[1-9]+[0-9]*(\.\d+)?$/" value="" class="width100"/>
            <span class="info">元/小时</span>
        </div>
        <div class="text_info clearfix"><span>资费说明：</span></div>
        <div class="input_info_high">
            <textarea class="width300 height70" name="desr" datatype="s0-100"></textarea>
        </div>
