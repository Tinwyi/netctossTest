...
<div id="main">
    ...
    <form action="addAdmin" method="post" class="main_form">
        ...
        <div class="input_info">
            <input type="text" name="name" datatype="s1-20" errormsg="20长度以内的汉字、字母、数字的组合"/>
        </div>
        <div class="text_info clearfix"><span>管理员账号：</span></div>
        <div class="input_info">
            <input type="text" name="adminCode" datatype="s1-30" ajaxurl="checkAdminCode" errormsg="30长度以内的字母、数字和下划线的组合"/>
        </div>
        <div class="text_info clearfix"><span>密码：</span></div>
        <div class="input_info">
            <input type="password" name="password" datatype="s1-30" errormsg="密码范围在1~30位之间！"/>
        </div>
        <div class="text_info clearfix"><span>重复密码：</span></div>
        <div class="input_info">
            <input type="password"  name="password2" datatype="*" recheck="password" errormsg="您两次输入的账号密码不一致！"/>
        </div>
        <div class="text_info clearfix"><span>电话：</span></div>
        <div class="input_info">
            <input type="text" name="telephone" datatype="m" errormsg="请输入正确的手机号！" class="width200"/>
        </div>
        <div class="text_info clearfix"><span>Email：</span></div>
        <div class="input_info">
            <input type="text" name="email" datatype="e" errormsg="邮箱格式不正确！" class="width200"/>
        </div>
